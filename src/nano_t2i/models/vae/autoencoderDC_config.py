...
@dataclass
class AutoencoderDCDiffusersConfig(ModelConfig):
    ...
    Args:
        ...
        dummy_encoder (bool): Whether to use a dummy encoder. Defaults to False.
    """

    version: Optional[str] = "stabilityai/sdxl-vae"
